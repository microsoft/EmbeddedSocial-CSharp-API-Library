...
namespace SocialPlus.Client
{
    ...
    /// MyTopics operations.
    /// </summary>
    public partial interface IMyTopics
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<FeedResponseTopicView>> GetPopularTopicsWithHttpMessagesAsync(string authorization, int? cursor = default(int?), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
