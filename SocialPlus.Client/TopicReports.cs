...
namespace SocialPlus.Client
{
    ...
    /// </summary>
    public partial class TopicReports : IServiceOperations<SocialPlusClient>, ITopicReports
    {
        /// <summary>
        ...
        /// </param>
        public TopicReports(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<object>> PostReportWithHttpMessagesAsync(string topicHandle, PostReportRequest postReportRequest, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/topics/{topicHandle}/reports").ToString();
