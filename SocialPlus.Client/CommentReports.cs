...
namespace SocialPlus.Client
{
    ...
    /// <summary>
    /// CommentReports operations.
    /// </summary>
    public partial class CommentReports : IServiceOperations<SocialPlusClient>, ICommentReports
    {
        /// <summary>
        ...
        /// </param>
        public CommentReports(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> PostReportWithHttpMessagesAsync(string commentHandle, PostReportRequest postReportRequest, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
