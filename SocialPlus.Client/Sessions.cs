...
namespace SocialPlus.Client
{
    ...
    /// Sessions operations.
    /// </summary>
    public partial class Sessions : IServiceOperations<SocialPlusClient>, ISessions
    {
        /// <summary>
        ...
        /// </param>
        public Sessions(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<PostSessionResponse>> PostSessionWithHttpMessagesAsync(PostSessionRequest request, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/sessions").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> DeleteSessionWithHttpMessagesAsync(string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (authorization == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "authorization");
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/sessions/current").ToString();
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
