...
namespace SocialPlus.Client
{
    ...
    /// MyApps operations.
    /// </summary>
    public partial class MyApps : IServiceOperations<SocialPlusClient>, IMyApps
    {
        /// <summary>
        ...
        /// </param>
        public MyApps(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<IList<AppCompactView>>> GetAppsWithHttpMessagesAsync(string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/me/apps").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<AppCompactView>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<AppCompactView>>(_responseContent, this.Client.DeserializationSettings);
                }
