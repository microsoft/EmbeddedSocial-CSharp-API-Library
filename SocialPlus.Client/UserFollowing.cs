...
namespace SocialPlus.Client
{
    ...
    /// <summary>
    /// UserFollowing operations.
    /// </summary>
    public partial class UserFollowing : IServiceOperations<SocialPlusClient>, IUserFollowing
    {
        /// <summary>
        ...
        /// </param>
        public UserFollowing(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FeedResponseUserCompactView>> GetFollowingWithHttpMessagesAsync(string userHandle, string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (userHandle == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetFollowing", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/{userHandle}/following").ToString();
