...
namespace SocialPlus.Client.Models
{
    ...
    /// Feed response
    /// </summary>
    public partial class FeedResponseActivityView
    {
        /// <summary>
        /// Initializes a new instance of the FeedResponseActivityView class.
        /// </summary>
        public FeedResponseActivityView() { }

        /// <summary>
        /// Initializes a new instance of the FeedResponseActivityView class.
        /// </summary>
        public FeedResponseActivityView(IList<ActivityView> data, string cursor)
        {
            Data = data;
            Cursor = cursor;
        }
        ...
        public IList<ActivityView> Data { get; set; }
