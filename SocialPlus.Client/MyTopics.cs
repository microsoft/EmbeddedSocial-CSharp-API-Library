...
namespace SocialPlus.Client
{
    ...
    public partial class MyTopics : IServiceOperations<SocialPlusClient>, IMyTopics
    {
        ...
        public async Task<HttpOperationResponse<FeedResponseTopicView>> GetTopicsWithHttpMessagesAsync(string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/me/topics").ToString();
        ...
        public async Task<HttpOperationResponse<FeedResponseTopicView>> GetPopularTopicsWithHttpMessagesAsync(string authorization, int? cursor = default(int?), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/me/topics/popular").ToString();
            List<string> _queryParameters = new List<string>();
            if (cursor != null)
            {
