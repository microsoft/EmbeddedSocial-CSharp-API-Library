...
namespace SocialPlus.Client
{
    ...
    /// Comments operations.
    /// </summary>
    public partial class Comments : IServiceOperations<SocialPlusClient>, IComments
    {
        /// <summary>
        ...
        /// </param>
        public Comments(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<CommentView>> GetCommentWithHttpMessagesAsync(string commentHandle, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.7/comments/{commentHandle}").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<CommentView>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CommentView>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> DeleteCommentWithHttpMessagesAsync(string commentHandle, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (commentHandle == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "commentHandle");
