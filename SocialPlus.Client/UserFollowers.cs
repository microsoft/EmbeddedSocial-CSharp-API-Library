...
namespace SocialPlus.Client
{
    ...
    /// <summary>
    /// UserFollowers operations.
    /// </summary>
    public partial class UserFollowers : IServiceOperations<SocialPlusClient>, IUserFollowers
    {
        /// <summary>
        ...
        /// </param>
        public UserFollowers(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FeedResponseUserCompactView>> GetFollowersWithHttpMessagesAsync(string userHandle, string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (userHandle == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/{userHandle}/followers").ToString();
