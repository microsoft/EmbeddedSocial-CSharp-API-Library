...
namespace SocialPlus.Client
{
    ...
    /// Blobs operations.
    /// </summary>
    public partial class Blobs : IServiceOperations<SocialPlusClient>, IBlobs
    {
        /// <summary>
        ...
        /// </param>
        public Blobs(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<PostBlobResponse>> PostBlobWithHttpMessagesAsync(string authorization, System.IO.Stream blob, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/blobs").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<System.IO.Stream>> GetBlobWithHttpMessagesAsync(string blobHandle, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (blobHandle == null)
            {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/blobs/{blobHandle}").ToString();
