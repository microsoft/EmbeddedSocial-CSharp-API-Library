...
namespace SocialPlus.Client
{
    ...
    /// </summary>
    public partial class UserReports : IServiceOperations<SocialPlusClient>, IUserReports
    {
        /// <summary>
        ...
        /// </param>
        public UserReports(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> PostReportWithHttpMessagesAsync(string userHandle, PostReportRequest postReportRequest, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (userHandle == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/{userHandle}/reports").ToString();
