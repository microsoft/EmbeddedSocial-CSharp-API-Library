...
namespace SocialPlus.Client
{
    ...
    /// </summary>
    public partial class CommentLikes : IServiceOperations<SocialPlusClient>, ICommentLikes
    {
        /// <summary>
        ...
        /// </param>
        public CommentLikes(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FeedResponseUserCompactView>> GetLikesWithHttpMessagesAsync(string commentHandle, string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/comments/{commentHandle}/likes").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> PostLikeWithHttpMessagesAsync(string commentHandle, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (commentHandle == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "commentHandle");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> DeleteLikeWithHttpMessagesAsync(string commentHandle, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (commentHandle == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "commentHandle");
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/comments/{commentHandle}/likes/me").ToString();
            _url = _url.Replace("{commentHandle}", Uri.EscapeDataString(commentHandle));
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
