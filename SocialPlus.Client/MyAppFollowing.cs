...
namespace SocialPlus.Client
{
    ...
    /// </summary>
    public partial class MyAppFollowing : IServiceOperations<SocialPlusClient>, IMyAppFollowing
    {
        /// <summary>
        ...
        /// </param>
        public MyAppFollowing(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FeedResponseUserCompactView>> GetUsersWithHttpMessagesAsync(string appHandle, string authorization, string cursor = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (appHandle == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "appHandle");
            }
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("appHandle", appHandle);
