...
namespace SocialPlus.Client
{
    ...
    /// <summary>
    /// TopicComments operations.
    /// </summary>
    public partial class TopicComments : IServiceOperations<SocialPlusClient>, ITopicComments
    {
        /// <summary>
        ...
        /// </param>
        public TopicComments(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FeedResponseCommentView>> GetTopicCommentsWithHttpMessagesAsync(string topicHandle, string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (topicHandle == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetTopicComments", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/topics/{topicHandle}/comments").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<FeedResponseCommentView>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<FeedResponseCommentView>(_responseContent, this.Client.DeserializationSettings);
                }
