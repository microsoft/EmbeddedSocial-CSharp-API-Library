...
namespace SocialPlus.Client
{
    ...
    /// MyLikes operations.
    /// </summary>
    public partial class MyLikes : IServiceOperations<SocialPlusClient>, IMyLikes
    {
        /// <summary>
        ...
        /// </param>
        public MyLikes(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FeedResponseTopicView>> GetLikedTopicsWithHttpMessagesAsync(string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetLikedTopics", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/users/me/likes/topics").ToString();
