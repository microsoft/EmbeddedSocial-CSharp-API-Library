...
namespace SocialPlus.Client
{
    ...
    /// <summary>
    /// ReplyReports operations.
    /// </summary>
    public partial class ReplyReports : IServiceOperations<SocialPlusClient>, IReplyReports
    {
        /// <summary>
        ...
        /// </param>
        public ReplyReports(SocialPlusClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> PostReportWithHttpMessagesAsync(string replyHandle, PostReportRequest postReportRequest, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (replyHandle == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.8/replies/{replyHandle}/reports").ToString();
