...
namespace SocialPlus.Client
{
    ...
    public partial class MyFollowers : IServiceOperations<SocialPlusClient>, IMyFollowers
    {
        ...
        public async Task<HttpOperationResponse<FeedResponseUserCompactView>> GetFollowersWithHttpMessagesAsync(string authorization, string cursor = default(string), int? limit = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.7/users/me/followers").ToString();
        ...
        public async Task<HttpOperationResponse<object>> DeleteFollowerWithHttpMessagesAsync(string userHandle, string authorization, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v0.7/users/me/followers/{userHandle}").ToString();
